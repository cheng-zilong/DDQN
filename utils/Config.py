...
def get_default_parser():
    ...
    parser.add_argument('--update_target_freq', type=int, default=40000)
    ...
    parser.add_argument('--eval_video_fps', type=int, default=15, help="Export *eval_video_fps* frames per second in the video")
